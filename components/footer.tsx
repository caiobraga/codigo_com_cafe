        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            />
              ...
              <div className="text-gray-400">Código com Café é uma empresa de desenvolvimento de software que oferece soluções personalizadas e inovadoras para os seus clientes.  </div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Link href="#indooh car" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Indooh Car</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="#data geosis" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Data Geosis</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="#vetners" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Vetners</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="#compara preco" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Compara Preço</Link>
                  </li>
                </ul>
              </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            */}
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; Código com Café. 2023, Todos os direitos reservados.</div>
